...
----------- | ---- | ----- | -----
Hard | Depth-first Search, Graph, Topological Sort | [Leetcode](https://leetcode.com/problems/sort-items-by-groups-respecting-dependencies) | [solution](https://leetcode.com/problems/sort-items-by-groups-respecting-dependencies/solution/)
