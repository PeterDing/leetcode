...
----------- | ---- | ----- | -----
Medium | Hash Table, Dynamic Programming | [Leetcode](https://leetcode.com/problems/longest-string-chain) | [solution](https://leetcode.com/problems/longest-string-chain/solution/)
