...
----------- | ---- | ----- | -----
Medium | Breadth-first Search, Graph | [Leetcode](https://leetcode.com/problems/as-far-from-land-as-possible) | [solution](https://leetcode.com/problems/as-far-from-land-as-possible/solution/)
...
- [Hard] [Shortest Distance from All Buildings](shortest-distance-from-all-buildings)
