...
----------- | ---- | ----- | -----
Medium | Hash Table, Greedy | [Leetcode](https://leetcode.com/problems/largest-values-from-labels) | [solution](https://leetcode.com/problems/largest-values-from-labels/solution/)
