...
----------- | ---- | ----- | -----
Hard | String, Dynamic Programming | [Leetcode](https://leetcode.com/problems/distinct-subsequences) | [solution](https://leetcode.com/problems/distinct-subsequences/solution/)
