...
----------- | ---- | ----- | -----
Medium | Array, Greedy | [Leetcode](https://leetcode.com/problems/previous-permutation-with-one-swap) | [solution](https://leetcode.com/problems/previous-permutation-with-one-swap/solution/)
