...
----------- | ---- | ----- | -----
Medium | Math, Recursion | [Leetcode](https://leetcode.com/problems/valid-tic-tac-toe-state) | [solution](https://leetcode.com/problems/valid-tic-tac-toe-state/solution/)
...
- [Medium] [Design Tic-Tac-Toe](design-tic-tac-toe)
