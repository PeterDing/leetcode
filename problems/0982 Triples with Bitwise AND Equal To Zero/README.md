...
----------- | ---- | ----- | -----
Hard | Dynamic Programming | [Leetcode](https://leetcode.com/problems/triples-with-bitwise-and-equal-to-zero) | [solution](https://leetcode.com/problems/triples-with-bitwise-and-equal-to-zero/solution/)
