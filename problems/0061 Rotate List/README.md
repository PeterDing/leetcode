...
----------- | ---- | ----- | -----
Medium | Linked List, Two Pointers | [Leetcode](https://leetcode.com/problems/rotate-list) | [solution](https://leetcode.com/problems/rotate-list/solution/)
...
- [Easy] [Rotate Array](rotate-array)
