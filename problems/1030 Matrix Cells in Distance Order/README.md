...
----------- | ---- | ----- | -----
Easy | Sort | [Leetcode](https://leetcode.com/problems/matrix-cells-in-distance-order) | [solution](https://leetcode.com/problems/matrix-cells-in-distance-order/solution/)
