...
----------- | ---- | ----- | -----
Hard | Dynamic Programming, Greedy | [Leetcode](https://leetcode.com/problems/create-maximum-number) | [solution](https://leetcode.com/problems/create-maximum-number/solution/)
...
- [Medium] [Maximum Swap](maximum-swap)
