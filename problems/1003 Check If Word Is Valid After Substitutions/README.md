...
----------- | ---- | ----- | -----
Medium | String, Stack | [Leetcode](https://leetcode.com/problems/check-if-word-is-valid-after-substitutions) | [solution](https://leetcode.com/problems/check-if-word-is-valid-after-substitutions/solution/)
