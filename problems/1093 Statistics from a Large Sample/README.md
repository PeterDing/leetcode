...
----------- | ---- | ----- | -----
Medium | Math, Two Pointers | [Leetcode](https://leetcode.com/problems/statistics-from-a-large-sample) | [solution](https://leetcode.com/problems/statistics-from-a-large-sample/solution/)
