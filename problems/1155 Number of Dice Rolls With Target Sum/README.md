...
----------- | ---- | ----- | -----
Medium | Dynamic Programming | [Leetcode](https://leetcode.com/problems/number-of-dice-rolls-with-target-sum) | [solution](https://leetcode.com/problems/number-of-dice-rolls-with-target-sum/solution/)
