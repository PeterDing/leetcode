...
----------- | ---- | ----- | -----
Medium | Dynamic Programming | [Leetcode](https://leetcode.com/problems/unique-substrings-in-wraparound-string) | [solution](https://leetcode.com/problems/unique-substrings-in-wraparound-string/solution/)
