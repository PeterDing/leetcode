...
----------- | ---- | ----- | -----
Hard | Dynamic Programming, Depth-first Search, Trie | [Leetcode](https://leetcode.com/problems/concatenated-words) | [solution](https://leetcode.com/problems/concatenated-words/solution/)
