...
----------- | ---- | ----- | -----
Hard | Stack, Greedy | [Leetcode](https://leetcode.com/problems/remove-duplicate-letters) | [solution](https://leetcode.com/problems/remove-duplicate-letters/solution/)
