...
----------- | ---- | ----- | -----
Easy | Stack | [Leetcode](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string) | [solution](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string/solution/)
...
- [Medium] [Remove All Adjacent Duplicates in String II](remove-all-adjacent-duplicates-in-string-ii)
