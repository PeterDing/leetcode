...
----------- | ---- | ----- | -----
Easy | Bit Manipulation | [Leetcode](https://leetcode.com/problems/convert-a-number-to-hexadecimal) | [solution](https://leetcode.com/problems/convert-a-number-to-hexadecimal/solution/)
