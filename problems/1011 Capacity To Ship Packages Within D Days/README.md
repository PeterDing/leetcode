...
----------- | ---- | ----- | -----
Medium | Array, Binary Search | [Leetcode](https://leetcode.com/problems/capacity-to-ship-packages-within-d-days) | [solution](https://leetcode.com/problems/capacity-to-ship-packages-within-d-days/solution/)
