...
----------- | ---- | ----- | -----
Medium | Dynamic Programming, Heap, Breadth-first Search | [Leetcode](https://leetcode.com/problems/cheapest-flights-within-k-stops) | [solution](https://leetcode.com/problems/cheapest-flights-within-k-stops/solution/)
...
- [Hard] [Maximum Vacation Days](maximum-vacation-days)
