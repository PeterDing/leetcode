...
----------- | ---- | ----- | -----
Medium | Dynamic Programming, Minimax | [Leetcode](https://leetcode.com/problems/can-i-win) | [solution](https://leetcode.com/problems/can-i-win/solution/)
...
- [Medium] [Predict the Winner](predict-the-winner)
