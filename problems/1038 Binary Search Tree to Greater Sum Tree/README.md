...
----------- | ---- | ----- | -----
Medium | Binary Search Tree | [Leetcode](https://leetcode.com/problems/binary-search-tree-to-greater-sum-tree) | [solution](https://leetcode.com/problems/binary-search-tree-to-greater-sum-tree/solution/)
