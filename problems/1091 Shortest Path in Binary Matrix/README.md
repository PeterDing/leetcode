...
----------- | ---- | ----- | -----
Medium | Breadth-first Search | [Leetcode](https://leetcode.com/problems/shortest-path-in-binary-matrix) | [solution](https://leetcode.com/problems/shortest-path-in-binary-matrix/solution/)
