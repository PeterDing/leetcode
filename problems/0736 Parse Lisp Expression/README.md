...
----------- | ---- | ----- | -----
Hard | String | [Leetcode](https://leetcode.com/problems/parse-lisp-expression) | [solution](https://leetcode.com/problems/parse-lisp-expression/solution/)
...
- [Hard] [Basic Calculator IV](basic-calculator-iv)
