...
----------- | ---- | ----- | -----
Medium | Depth-first Search, Union Find | [Leetcode](https://leetcode.com/problems/friend-circles) | [solution](https://leetcode.com/problems/friend-circles/solution/)
...
- [Easy] [Robot Return to Origin](robot-return-to-origin)
