...
----------- | ---- | ----- | -----
Medium | Two Pointers, Sliding Window | [Leetcode](https://leetcode.com/problems/max-consecutive-ones-iii) | [solution](https://leetcode.com/problems/max-consecutive-ones-iii/solution/)
...
- [Easy] [Max Consecutive Ones](max-consecutive-ones)
