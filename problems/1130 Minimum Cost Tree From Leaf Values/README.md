...
----------- | ---- | ----- | -----
Medium | Dynamic Programming, Stack, Tree | [Leetcode](https://leetcode.com/problems/minimum-cost-tree-from-leaf-values) | [solution](https://leetcode.com/problems/minimum-cost-tree-from-leaf-values/solution/)
