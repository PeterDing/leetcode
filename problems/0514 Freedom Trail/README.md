...
----------- | ---- | ----- | -----
Hard | Divide and Conquer, Dynamic Programming, Depth-first Search | [Leetcode](https://leetcode.com/problems/freedom-trail) | [solution](https://leetcode.com/problems/freedom-trail/solution/)
