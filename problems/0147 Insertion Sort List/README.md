...
----------- | ---- | ----- | -----
Medium | Linked List, Sort | [Leetcode](https://leetcode.com/problems/insertion-sort-list) | [solution](https://leetcode.com/problems/insertion-sort-list/solution/)
...
- [Medium] [Insert into a Cyclic Sorted List](insert-into-a-cyclic-sorted-list)
