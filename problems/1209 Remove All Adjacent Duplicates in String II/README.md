...
----------- | ---- | ----- | -----
Medium | Stack | [Leetcode](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string-ii) | [solution](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string-ii/solution/)
...
- [Easy] [Remove All Adjacent Duplicates In String](remove-all-adjacent-duplicates-in-string)
