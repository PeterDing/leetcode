...
----------- | ---- | ----- | -----
Medium | Array, Greedy | [Leetcode](https://leetcode.com/problems/minimum-domino-rotations-for-equal-row) | [solution](https://leetcode.com/problems/minimum-domino-rotations-for-equal-row/solution/)
