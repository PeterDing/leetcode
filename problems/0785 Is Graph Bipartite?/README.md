...
----------- | ---- | ----- | -----
Medium | Depth-first Search, Breadth-first Search, Graph | [Leetcode](https://leetcode.com/problems/is-graph-bipartite) | [solution](https://leetcode.com/problems/is-graph-bipartite/solution/)
