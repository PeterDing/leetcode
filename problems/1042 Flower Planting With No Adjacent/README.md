...
----------- | ---- | ----- | -----
Easy | Graph | [Leetcode](https://leetcode.com/problems/flower-planting-with-no-adjacent) | [solution](https://leetcode.com/problems/flower-planting-with-no-adjacent/solution/)
