...
----------- | ---- | ----- | -----
Medium | Breadth-first Search, Graph | [Leetcode](https://leetcode.com/problems/shortest-path-with-alternating-colors) | [solution](https://leetcode.com/problems/shortest-path-with-alternating-colors/solution/)
