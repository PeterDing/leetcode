...
----------- | ---- | ----- | -----
Hard | String, Dynamic Programming, Backtracking, Greedy | [Leetcode](https://leetcode.com/problems/wildcard-matching) | [solution](https://leetcode.com/problems/wildcard-matching/solution/)
