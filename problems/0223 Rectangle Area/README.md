...
----------- | ---- | ----- | -----
Medium | Math | [Leetcode](https://leetcode.com/problems/rectangle-area) | [solution](https://leetcode.com/problems/rectangle-area/solution/)
...
- [Easy] [Rectangle Overlap](rectangle-overlap)
