...
----------- | ---- | ----- | -----
Medium | Math, Random, Rejection Sampling | [Leetcode](https://leetcode.com/problems/generate-random-point-in-a-circle) | [solution](https://leetcode.com/problems/generate-random-point-in-a-circle/solution/)
