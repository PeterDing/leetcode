...
----------- | ---- | ----- | -----
Medium | Hash Table, Linked List | [Leetcode](https://leetcode.com/problems/copy-list-with-random-pointer) | [solution](https://leetcode.com/problems/copy-list-with-random-pointer/solution/)
