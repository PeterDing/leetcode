...
----------- | ---- | ----- | -----
Medium | Linked List, Stack | [Leetcode](https://leetcode.com/problems/next-greater-node-in-linked-list) | [solution](https://leetcode.com/problems/next-greater-node-in-linked-list/solution/)
