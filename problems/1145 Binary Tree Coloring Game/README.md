...
----------- | ---- | ----- | -----
Medium | Tree, Depth-first Search | [Leetcode](https://leetcode.com/problems/binary-tree-coloring-game) | [solution](https://leetcode.com/problems/binary-tree-coloring-game/solution/)
